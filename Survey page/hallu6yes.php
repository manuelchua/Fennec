    ...
    <div class="row justify-content-center">
      <div class="col-lg-8 align-self-center text-center">
        <div class="header-text">
          <h2 class = "fs-1 lh-sm">Thanks for letting me know!</h2>
        </div>
      </div>
      <div class="row justify-content-center text-center">
        <div class="col-lg-4 align-self-center">
          <div class="main-photo">
            <img src="../assets\images\fennecHappy.png" class ="img-fluid" alt="">
          </div>
        </div>
      </div>
      <form method = "POST">
      <div class="container">
                ...
                <div class="col-sm text-center m-3">
                    <div class="main-button-gradient choice-text" id="hallucinationsone"><a href="ocd1.php">Next</a></div>
                </div>
          </div>
        </div>
        </form>
