    ...
    <div class="row justify-content-center">
      <div class="col-lg-8 align-self-center text-center">
        <div class="header-text">
          <h2 class = "fs-1 lh-sm">There are many ways to dispell auditory hallucinations. What I offer help with with are ones that distract you from them that don't need anything other than your device! <br> Would you still like my assistance on this?</h2>
        </div>
      </div>
      <div class="row justify-content-center text-center">
        <div class="col-lg-4 align-self-center">
          <div class="main-photo">
            <img src="../assets\images\fennecwriting.png" class ="img-fluid" alt="">
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-sm text-center m-3">
            <div class="main-button-gradient">
                <div><a href="ocd1.php">NO</a></div>
            </div>
          </div>
          <div class="col-sm text-center m-3">
            <div class="main-button-gradient">
                <div><a href="hallu3.php">Yes</a></div>
            </div>
          </div>
        </div>
      </div>
